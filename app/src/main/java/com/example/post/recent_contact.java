...
public class recent_contact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        barprofileimage = findViewById(R.id.rc_dp);
        barprofilename = findViewById(R.id.rc_user);

        Calendar calFordTime = Calendar.getInstance();
        SimpleDateFormat currentTime = new SimpleDateFormat("HH:mm");
        saveCurrentTime = currentTime.format(calFordTime.getTime());

        send = findViewById(R.id.rc_send_msg);
        message = findViewById(R.id.rc_message);
        Sender_id = findViewById(R.id.rc_cid);
        Reciever_id = findViewById(R.id.rc_rid);


        recyclerView = findViewById(R.id.rc_messages_list_of_users);
        ...
        mToolbar = findViewById(R.id.rc_bar);
        ...
        final contactsgs discpost = (contactsgs) intent.getSerializableExtra("Clickable");
        ...
        Reff.child(cReciever_id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    Toast.makeText(recent_contact.this, "please select profile image first" , Toast.LENGTH_LONG).show();
                }
            }
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!text.equals("")){
                    ...
                    Toast.makeText(recent_contact.this, "message sent succesfuly.....", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(recent_contact.this, "first write your message...", Toast.LENGTH_SHORT).show();
                }
                message.setText("");
            }
        });
        ...
        refrence.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot :dataSnapshot.getChildren()){
                    ...
                    messageAdapter = new MessageAdapter(recent_contact.this, mchat);
    ...
    private void SendUserToMain() {
        ...
        Intent e=new Intent(recent_contact.this,MainActivity.class);
        startActivity(e);
